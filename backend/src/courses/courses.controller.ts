...
export class CoursesController {
  ...
  @UseGuards(AuthGuard, RoleGuard)
  @Roles('instructor')
  getInstructorStatistics(@Req() req) {
    return this.coursesService.getInstructorStatistics(req.user.sub);
  }

  @Get('instructor/students')
  @UseGuards(AuthGuard, RoleGuard)
  @Roles('instructor')
  getInstructorStudents(@Req() req) {
    return this.coursesService.getInstructorStudents(req.user.sub);
  }
  ...
  update(
    ...
    if (thumbnail) {
      updateCourseDto.thumbnail = thumbnail;
    }
