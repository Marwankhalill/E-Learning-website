...
export class LessonsController {
  ...
  @Post(':id/mark-viewed')
  @UseGuards(AuthGuard)
  markAsViewed(@Param('id') id: MongoIdDto, @Req() req) {
    return this.lessonsService.markAsViewed(id, req.user.sub);
  }

  @Get('progress/:courseId')
  @UseGuards(AuthGuard)
  getUserProgress(@Param('courseId') courseId: MongoIdDto, @Req() req) {
    return this.lessonsService.getUserProgress(req.user.sub, courseId);
  }
}
